    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-8 font-sans">
      ...
      <div className="bg-[#0a0a1a] border border-purple-500/40 backdrop-blur-xl 
        ...
        <p className="text-purple-300 mb-10 text-sm font-medium opacity-80 
          ...
          ACCESS GRANTED — WELCOME TO THE NEON INTERFACE
        </p>

        {/* Grid Menu */}
        <div className="grid grid-cols-2 gap-5 mb-10">

          <div className="bg-purple-600/20 hover:bg-purple-600/40 text-purple-300 
          ...
          <div className="bg-blue-600/20 hover:bg-blue-600/40 text-blue-300 
          ...
          <div className="bg-pink-600/20 hover:bg-pink-600/40 text-pink-300 
                          p-5 rounded-xl border border-pink-500/40 
                          shadow-[0_0_12px_rgba(236,72,153,0.4)]
                          cursor-pointer transition duration-200 
          ...
          <div className="bg-green-600/20 hover:bg-green-600/40 text-green-300 
                          p-5 rounded-xl border border-green-500/40
